...
<AuthorizationHandler>
  <Input required authType="http" authName="session_token" valueName="HTTP Bearer" valueType="string" valueDescription="Uses the sessiontoken generate from the generate token endpoint" valueExample="sdfzuasdfhahbsdf" inputType="password" inputPlaceholder="sessiontoken"/>
</AuthorizationHandler>
