...
<Input valueName="HTTP Bearer" valueType="string" required="true" inputType="password" exampleValue="sessiontoken" valueDescription="Uses the sessiontoken generate from the generate token endpoint"/>
