...
<Input valueName="HTTP Bearer" valueType="string" required disabled inputType="number" exampleValue="sessiontoken" valueDescription="Uses the sessiontoken generate from the generate token endpoint"/>
