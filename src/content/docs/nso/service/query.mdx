...
<Tree>
  - Pet
    - id (description: test) (type: int)
    - name (description: test) (type: string) (required)
    - category
      - id (description: test) (type: int) (required)
      - name (description: test) (type: string) (required)
    - photoUrls (description: test) (type: [string]) (required)
    - tags (description: test) (type: [object])
    - status (description: test) (type: string)
</Tree>
