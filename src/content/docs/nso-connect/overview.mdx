...
When building applications that create session tokens and perform queries on the behalf of a user, you must follow the following guidelines:
    ...
    * Users must be informed of the use of this API and presented with the [Privacy Policy and Safety Disclaimer](/nso-connect/safety). 
...
Nintendo has previously taken action against irresponsible developers who have put heavy loads on their servers. You can read about the incident on the [Privacy and Safety](/nso-connect/safety#about-safety) page.  
