...
<Input required valueType="string" valueDescription="Name of your application or contact information. Should either be in the format {appName}/{version} or provide contact information." valueExample="docs/1.0.0" inputName="X-Agent" inputType="text" inputPlaceholder="docs/1.0.0" requestType="header"/>
