...
<AuthorizationHandler>
  <Input required authType="http" authName="session_token" valueType="string" valueDescription="Uses the sessiontoken generate from the generate token endpoint" valueExample="" inputName="Session Token" inputType="password" inputPlaceholder="sessiontoken" requestType="authorization"/>
