...
<Input valueName="HTTP Bearer" valueType="string" required disabled inputType="text" exampleValue="sessiontoken" valueDescription="Uses the sessiontoken generate from the generate token endpoint"/>

<Button filled loading disabled>aaaaaaaaa</Button>
