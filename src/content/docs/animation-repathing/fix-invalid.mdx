...
![Fix Invalid Paths](/images/invalid.gif)
...
- You can drag and drop GameObjects from the Hierarchy into the text field to automatically fill in the property path.
   ...
   ![Drag And Drop GameObject](/images/invalid-gameobject.gif)

- Using the drop down menu, you can view and select the Animation Clips that contain invalid property paths.

   ![Invalid Path Dropdown](/images/invalid-dropdown.gif)

- You can reset the property path to its original value by clicking the reset button.

   ![Reset Button](/images/invalid-reset.gif)